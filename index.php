...
<tr>
    ...
    <th style="width: 60px;"><?php echo sorteerKopLink('bestanden', '🗂️', '▼', 'Sorteer op meeste bestandsafwijkingen eerst', $categorie, $sorteerOp, $richting); ?><?php echo hulpIcoon('beveiliging', 'Aantal extensiebestanden dat afwijkt van de meerderheid van andere gemonitorde sites (bijv. een andere editie of build) - géén vergelijking met een officieel pakket, dus een zachter signaal dan de Beveiliging-kolom. Groen vinkje = geen afwijkingen.'); ?></th>
